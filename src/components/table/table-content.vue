      ...
      <thead>
        <tr class="border-b border-gray-200">
          ...
          <th
            ...
            :class="[
              'typo-sm-medium px-6 py-3 text-neutral-500',
      ...
      <tbody>
        ...
        <template v-else>
          <tr
            ...
            :key="rowIndex"
            :class="[
              'transition-colors last:border-b last:border-gray-200',
          ...
          >
            ...
            >
              ...
              <template v-else-if="column.customRender === 'link'">
                ...
                <template v-else>
                  <a
                    ...
                    class="cursor-pointer text-neutral-800 underline transition-colors"
                    @click.stop
                  >
                    {{ row[column.key] }}
                  </a>
              ...
              <template v-else-if="column.customRender === 'actions'">
                <div class="flex h-full w-full items-center justify-center gap-3" @click.stop>
                  <!-- 編輯按鈕 -->
                  <button
                    v-if="showEditButton"
                    class="btn-icon-cell"
