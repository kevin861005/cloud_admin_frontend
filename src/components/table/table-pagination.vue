  ...
  <div class="flex items-center justify-between border-gray-200 bg-white px-1">
    ...
    <div class="flex items-center gap-[41px]">
      ...
      <div class="flex items-center gap-2">
        ...
        <select
          :value="pageSize"
          class="rounded border border-gray-300 bg-white px-3 py-1 typo-sm text-neutral-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
