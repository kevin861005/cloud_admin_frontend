<template>
  <button
    class="typo-xs-bold inline-flex h-6 cursor-pointer items-center justify-center gap-2 rounded border border-neutral-200 bg-neutral-100 px-2 py-1 text-neutral-700 transition-colors hover:bg-neutral-200"
    @click="handleClick"
  >
    <!-- 圖片在左邊 -->
    <img
