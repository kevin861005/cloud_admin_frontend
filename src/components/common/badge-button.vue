<template>
  <button
    class="inline-flex items-center justify-center gap-2 h-6 px-2 py-1 rounded border border-gray-200 text-xs font-bold tracking-[0.2px] text-gray-700 bg-gray-100 cursor-pointer hover:bg-opacity-80 transition-colors"
    @click="handleClick"
  >
    <!-- 圖片在左邊 -->
    <img
