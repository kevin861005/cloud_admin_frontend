<template>
  ...
  >
    ...
    <div class="mb-3 flex items-center justify-between">
      ...
      <!-- 修改資料按鈕 -->
      <button
        class="typo-xs-bold group inline-flex h-9 cursor-pointer items-center justify-center gap-1 rounded pl-3 pr-4 text-neutral-600 transition-colors hover:border-primary-500 hover:text-primary-500"
    ...
    <!-- 產業別 -->
    <p class="typo-sm mb-4 text-neutral-600">
      {{ customerInfo.industry }}
    </p>

    <!-- 次要資訊（使用時間、模組、負責業務、建立日期）-->
    <div class="typo-sm-medium flex items-center gap-3 text-neutral-600">
